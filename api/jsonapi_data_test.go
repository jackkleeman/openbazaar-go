...
const avatarValidJSONResponse = `{
    "tiny": "QmduJbMJpAqx8pcBrXHgHHy9mqGPyxNPTfBLqXnQtjm45y",
    "small": "QmVdi2tKtS4mA2eoK1KkBF8ZQ1gWrwCCcCG81F13Rum9hA",
    "medium": "QmQ8mcSsh9HsWYhC4zvgZAmDquTeqJH7cM2LvnMpGB3Sdt",
    "large": "QmUuSDAa93p9MqYySwG3t7oGzSTkga5XfxreWMCyFVB82L",
...
const listingValidJSONResponse = `{"slug": "ron_swanson_tshirt"}`

const listingUpdateValidJSON = `{
	"listing": {
		"slug": "ron_swanson_tshirt",
		"vendorID": {
			"guid": "QmbP4QdAWjoYr2AyhNasZD7Ksjfh5mWWontFRTKX7Mq9ci",
...
const listingUpdateNonExistantJSON = `{
	"listing": {
		"slug": "foo",
		"vendorID": {
			"guid": "QmbP4QdAWjoYr2AyhNasZD7Ksjfh5mWWontFRTKX7Mq9ci",
