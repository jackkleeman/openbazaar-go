...
func TestListings(t *testing.T) {
	runJSONAPIBlackboxTests(t, jsonAPIBlackboxTests{
		...
		{"POST", "/ob/listing", listingValidJSON, 200, listingValidJSONResponse},
		{"GET", "/ob/listing/ron_swanson_tshirt", "", 200, anyResponseJSON},
		{"POST", "/ob/listing", listingUpdateValidJSON, 409, AlreadyExistsUsePUTJSON("Listing")},

		// Update/Get
		{"PUT", "/ob/listing", listingUpdateValidJSON, 200, `{}`},
		{"GET", "/ob/listing/ron_swanson_tshirt", "", 200, anyResponseJSON},

		// Delete/Get
		{"DELETE", "/ob/listing", listingValidJSONResponse, 200, `{}`},
		{"GET", "/ob/listing/ron_swanson_tshirt", "", 404, NotFoundJSON("Listing")},

		// Mutate non-existing listings
		{"PUT", "/ob/listing", listingUpdateNonExistantJSON, 404, NotFoundJSON("Listing")},
		{"DELETE", "/ob/listing", listingValidJSONResponse, 404, NotFoundJSON("Listing")},
	})
}
